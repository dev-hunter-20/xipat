  ...
  return (
    <div className='pricing container'>
      ...
      <h3 className='description'>
        Looking for a tool to monitor and optimize your app ranking? TRY{" "}
        <b>LET'S METRIX</b> for FREE NOW
      </h3>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className='price'>
              ...
              <br />
              <span>
                ${listProductPlanStandard?.monthlyPrice ?? ""}/monthly
              </span>
            </td>
            <td className='price'>
            ...
            <td className='price'>
              ...
              <br />
              <span>
                ${listProductPlanUnlimited?.monthlyPrice ?? ""}/monthly
              </span>
            </td>
          </tr>
          <tr>
