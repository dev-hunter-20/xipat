  ...
  return (
    <Spin spinning={loading}>
      <div className='detail-categories '>
        {showApps && (
          <ModalListApp id={idDeveloper.current} handleCancel={handleCancel} />
        )}
          ...
          <div className='container-title-body'>
            <div className='wrapper-title'>
              ...
              <div className='title-apps'>
                {listDevelopers ? listDevelopers.length : "0"} Developers
              </div>
            </div>
          </div>
              ...
              ? listDevelopers.map((itemChild, index) => {
                  return (
                    ...
                    >
                      <Row>
                        <Col span={5}>
                          <a href={`/developer/${itemChild._id}`}>
                            {itemChild.name}
                          </a>
                        </Col>
                        <Col span={5}>
                          ...
                          >
                            {`${itemChild.count_app}${
                              itemChild.count_app > 1 ? " apps" : " app"
                            }`}
                          </a>
                        </Col>
                        <Col span={4}>
...
export default DevelopersByDay;
