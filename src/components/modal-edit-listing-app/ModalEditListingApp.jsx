    ...
    >
      <div className="popup-edit-listing-app">
        <div className="edit-listing-app">
          ...
          <div className="edit-plan-detail">
        ...
        <div className="table-view-keyworod">
          <div className="add-keyword">
            <Input placeholder="Add keyword" ref={keywordAdd} />
            <div className="button-add">
              <Button type="primary" onClick={saveKeyword}>
                Add
              </Button>
            </div>
          </div>
          <Table columns={columnsKeyword} dataSource={dataKeywordsShow} pagination={false} />
        </div>
      </div>
    </Modal>
  );
